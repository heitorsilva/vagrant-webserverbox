Vagrant.configure(2) do |config|
  ...
  config.vm.provision "file", source: "get-pip.py", destination: "/tmp/get-pip.py"
  ...
  config.vm.provision "shell", path: "install-python.sh", privileged: false
